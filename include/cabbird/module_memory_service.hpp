...
public:
    [[nodiscard]] std::vector<cabbird::mem::ModuleInfo> EnumerateModules() const;
    [[nodiscard]] std::optional<cabbird::mem::ModuleInfo> FindModule(
        std::wstring_view name) const;
    [[nodiscard]] std::vector<cabbird::mem::SectionInfo> EnumerateSections(
        const cabbird::mem::ModuleInfo& module) const;
    [[nodiscard]] std::vector<cabbird::mem::RegionInfo> EnumerateRegions(
        const cabbird::mem::ModuleInfo& module) const;
    [[nodiscard]] std::vector<cabbird::mem::RegionInfo> EnumerateProcessRegions() const;
