...
void Usage() {
    std::cerr << "usage: cabbird-cli --pid <pid> <command> [arguments...]\n"
                 "example: cabbird-cli --pid 1234 modules\n";
}
...
int wmain(int argc, wchar_t** argv) {
    ...
    request.push_back('\n');
    const std::wstring pipe_name = L"\\\\.\\pipe\\LOCAL\\Cabbird-" + std::to_wstring(pid);
