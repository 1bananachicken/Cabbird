#include "cabbird/repository_network.hpp"
...
#define CABBIRD_WIDEN_VERSION_IMPL(value) L##value
#define CABBIRD_WIDEN_VERSION(value) CABBIRD_WIDEN_VERSION_IMPL(value)

constexpr wchar_t kRepositoryUserAgent[] =
    L"Cabbird/" CABBIRD_WIDEN_VERSION(CABBIRD_SDK_VERSION_STRING) L" repository";

#undef CABBIRD_WIDEN_VERSION
#undef CABBIRD_WIDEN_VERSION_IMPL
