...
#include "cabbird/plugin_repository_config.hpp"
#include "cabbird/repository_network.hpp"
#include "cabbird/safe_zip.hpp"
#include "cabbird/semver.hpp"
...
private:
    ...
    [[nodiscard]] std::filesystem::path TransactionDirectory() const {
        return PluginDirectory().parent_path() / L".cabbird-plugin-transactions";
    }
